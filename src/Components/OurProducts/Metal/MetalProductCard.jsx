...
const MetalProductCard = ({product}) => {
                ...
                <div className="max-w-sm mx-auto bg-white text-black border border-black shadow-lg rounded-lg overflow-hidden mb-6">
                    ...
                    <div className="py-4 px-6">
                        ...
                        <div className="flex  mt-4">
                            <Link to={`/metal-product-details/${id}`}><button className='btn btn-outline w-[350px]'>See Details</button></Link>
                        </div>
                    </div>
                </div>
            </div>
...
export default MetalProductCard;