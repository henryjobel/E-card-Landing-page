        ...
        <div className='container mx-auto pb-40'>
            ...
            <form>
                ...
                <div className='mt-5'>
                    ...
                    <input type="text" placeholder="Price" defaultValue={selectedproduct.price}  className="input input-bordered input-info w-[350px]" />
                </div>
                </div>
                <div className='flex gap-5'>
                <div className='mt-5'>
                ...
                <Link to={`/checkout/${id}`} className='btn btn-outline w-full mt-5'>Place Your Oder</Link>
